...
class StylistController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Stylist']))
		{
			...
			if($model->save())
			{
				...
				$message->setBody('There is a new stylist applicant for Paul Kemp Hairdressing.<br>Name: '.$model->first_name.' '.$model->second_name.'<br>Experience: '.$model->experience.'<br>Email: '.$model->email.'<br> Mobile: '.$model->mobile.'<br>http://www.paulkemphairdressing.com/stylist/view/'.$model->stylist_id, 'text/html');
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('Stylist', array('criteria'=>$criteria, 
		'pagination'=>array(
			'pageSize'=>'5',
			),			
		));
