...
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/fibre_force3.jpg" width="135" height="111">
...
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/fibre_force2.jpg" width="135" height="108">
...
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/fibre_force.jpg" width="135" height="121">
...
<article class="article">
<a name="GoodSalonGuide" class="anchor"></a>
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/good_salon_guide.jpg" width="135" height="180">
...
<time datetime="2012-11-06" pubdate="pubdate"><p>6th November 2012</p></time>
</article> <!--end #article-->

<article class="article">
<a name="HairReborn" class="anchor"></a>
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/tigi-reborn.jpg" width="135" height="190">
...
<section class="hidden">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/tigi-awakening.jpg" width="135" height="120">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/tigi-resurgence.jpg" width="135" height="120">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/tigi-serenity.jpg" width="135" height="120">
...
<p class="author">Published by PK</p>
<time datetime="2012-11-01" pubdate="pubdate"><p>1st November 2012</p></time>
</article> <!--end #article-->

<article class="article">
<a name="Invati" class="anchor"></a>
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/invati-girl.jpg" width="135" height="190">
...
<section class="hidden">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/invati-products.jpg" width="135" height="190">
...
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/tigi_christmas.jpg" width="135" height="106">
...
<section class="hidden">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/Aveda-Christmas.jpg" width="135" height="160">
...
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/ghd_metallic.jpg" width="135" height="163">
...
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/merry-christmas.jpg" width="135" height="160">
...
<p class="author">Published by PK</p>
<time datetime="2012-11-30" pubdate="pubdate"><p>1st November 2012</p></time>
</article> <!--end #article-->

<article class="article">
<section class="visible">
<a name="NewStaff" class="anchor"></a>
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/jack2.jpg" width="135" height="190">
...
<section class="hidden">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/jack1.jpg" width="135" height="190">
<h3>Jack Broady</h3>
...
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/megan.jpg" width="135" height="190">
...
<p>We are still looking to take on experianced Stylist/Senior Stylists. If you would like to join the team <?php echo CHtml::link('Click Here',array('site/page','view'=>'recruitment')); ?></p>
</section> <!--end .hidden-->
<p class="author">Published by PK</p>
<time datetime="2012-08-30" pubdate="pubdate"><p>30th August 2012</p></time>
</article> <!--end #article-->


<article class="article">
<section class="visible">
<a name="PaulInterview" class="anchor"></a>
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/news_images/paul.jpg" width="135" height="190">
...
<time datetime="2012-07-04" pubdate="pubdate"><p>4th July 2012</p></time>
</article> <!--end #article-->


</section> <!--end #accoordion-->

<?php echo CHtml::link('Click here for older news stories &gt;',array('site/page','view'=>'news_archive')); ?>