...
<?php Yii::app()->facebook->ogTags['og:title'] = "New Client offers for Spring"; ?>
<?php Yii::app()->facebook->ogTags['og:description'] = "1/2 Price Colour with every Cut, Dry & Style for new clients throughout May"; ?>
...
<p class="small">offer until <time datetime="2015-05-29">29/05/14</time><br>
...
<div id="offer3" class="offer">
  ...
  <p>For &pound;16 with a Stylist<br>&pound;20 with a Senior Stylist<br></p>
    <p class="small">until <time datetime="2015-05-29">29/05/15</time><br>
