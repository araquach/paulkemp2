...
<?php Yii::app()->facebook->ogTags['og:title'] = "Special September Offers"; ?>
<?php Yii::app()->facebook->ogTags['og:description'] = "Colour & Cut for just £70 with Senior Stylists, £50 with Stylists for new clients"; ?>
<?php Yii::app()->facebook->ogTags['og:image'] = "http://www.paulkemphairdressing.com/images/offer/metalixx_meta.jpg"; ?>
...
<p class="small">offer extended until <time datetime="2014-09-30">30/09/14</time><br>
...
<div id="offer3" class="offer">
  <h3>30% off</h3>
  <p>Men's Cut &amp; Style<br>
    with any of our Stylists/Senior Stylists</p>
    <p class="small">offer extended until <time datetime="2014-09-30">30/09/14</time><br>
