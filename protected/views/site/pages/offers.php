...
<?php Yii::app()->facebook->ogTags['og:title'] = "Special January Offers"; ?>
<?php Yii::app()->facebook->ogTags['og:description'] = "Colour & Cut for just £80 with Senior Stylists, £65 with Stylists for new clients"; ?>
...
<p class="small">offer until <time datetime="2015-01-30">30/01/15</time><br>
...
<div id="offer3" class="offer">
  ...
  <p>For &pound;16 with a Stylist<br>&pound;20 with a Senior Stylist<br></p>
    <p class="small">until <time datetime="2015-01-30">30/01/15</time><br>
