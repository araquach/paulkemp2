...
<?php else: ?>
	...
	<?php else: ?>
	<?php echo 'Voucher for ' . ucfirst($model->first_name) . ' ' . ucfirst($model->last_name) . ': 40% off your next visit plus fixed prices on Colour & Cut package at £80, Cut, Dry & Style at £35, Dry & Style at £25 with Kellie, Izzy, Jo, Michelle or Kate until March 2014' ?>
	<?php endif; ?>
<?php endif; ?>