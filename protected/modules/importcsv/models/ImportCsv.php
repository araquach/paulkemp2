            ...
            for($k=0; $k<$linesLength; $k++) {
                ...
                for($i=0; $i<$columnsLength; $i++) {
                    if($columns[$i]!='') {
                        ...
                        $csvString   = ($n_in!=0) ? $csvString.", '".CHtml::encode(stripslashes($linesArray[$k][$columns[$i]-1]))."'" : str_replace('£','',$csvString)."'".CHtml::encode(stripslashes($linesArray[$k][$columns[$i]-1]))."'";
